...
# raw_audio_dir_path = f".\\raw_audio\\"
# if not os.path.exists(raw_audio_dir_path):
#     os.mkdir(f"{raw_audio_dir_path}")

# 如果沒有 'sentences' 這個資料夾就做一個
sentences_dir_path = ".\\sentences\\"
if not os.path.exists(sentences_dir_path):
    os.mkdir(sentences_dir_path)
...
for i in range(len(sentence)):
    audio_clip = audio[int(sentence[i][1] *1000): int(sentence[i][2]*1000)]
